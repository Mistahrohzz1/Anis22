...
def login():
        ...
        try:
                data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 9_2 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13C75 Safari/601.1","referer": "https://www.mbasic.facebook.com/","host": "mbasic.facebook.com","origin": "https://mbasic.facebook.com","upgrade-insecure-requests" : "1","accept-language": "en-BD,en-GB;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
